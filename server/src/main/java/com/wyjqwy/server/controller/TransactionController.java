...
public class TransactionController {
    ...
    @PostMapping
    public ApiResponse<Long> create(@Valid @RequestBody TransactionUpsertRequest request) {
        return ApiResponse.ok(transactionService.create(SecurityUtils.currentUserId(), request));
    }

    @PostMapping("/voice")
    public ApiResponse<VoiceTransactionResult> createByVoice(@Valid @RequestBody VoiceTransactionRequest request) {
        return ApiResponse.ok(transactionService.createByVoice(SecurityUtils.currentUserId(), request));
    }
