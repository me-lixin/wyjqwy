...
val expenseCategoryPresets: List<CategoryPreset> = listOf(
    ...
    CategoryPreset("投资理财", "expense_investment", Icons.Outlined.TrendingUp),
    CategoryPreset("烟酒糖茶", "tobacco_alcohol_tea", Icons.Outlined.LocalBar),
    CategoryPreset("工作办公", "work_office", Icons.Outlined.WorkOutline),
    CategoryPreset("老人小孩", "elder_child", Icons.Outlined.FamilyRestroom),
